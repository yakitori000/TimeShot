...
void sMapLayer::Init()
{
	...
	//マップ読み込み（レイヤーごとに）
	LayerLoader(layerHit, "data/NewGamehit2.csv");
	//LayerLoader(layerBack, "data/NewGame02.csv");
	LayerLoader(layerBase, "data/NewGame02.csv");
	//LayerLoader(layerNear, "data/NewGame02.csv");
